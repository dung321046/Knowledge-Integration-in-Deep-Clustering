...
root = root.conjoin(mgr.disjoin(model_b.f_must_link(0, 1, k, mgr), model_b.f_cannot_link(2, 0, k, mgr)))
root.ref()
mgr.minimize()
...
# g.render(view=True)
vtree = mgr.vtree()
vtree.save(bytes("triplet-k-10b.vtree", encoding="utf8"))
mgr.save(bytes("triplet-k-10b", encoding="utf8"), root)
